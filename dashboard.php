...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            //Simpan Dsn
            $("#contentData").on("submit", "#formDsn", function(e) {
                e.preventDefault();
                $.ajax({
            ...
            //hapus Dsn
            $("#contentData").on("click", "#deleteDsn", function() {
            ...
            //Edit Dsn
            $("#contentData").on("click", "#editDsn", function() {
                var kd_dosen = $(this).attr("value");
                $.ajax({
                    url: 'dosen/edit.php',
                    type: 'get',
            ...
            // Dsn
            $("#contentData").on("submit", "#formEditDsn", function(e) {
                e.preventDefault();
                $.ajax({
        ...
        // matkul
        $("#contentData").on("submit", "#formMtkl", function(e) {
                e.preventDefault();
                $.ajax({
            ...
            $("#contentData").on("click", "#deleteMtkl", function() {
            ...
            $("#contentData").on("click", "#editMtkl", function() {
                var kd_matkul = $(this).attr("value");
                $.ajax({
                    url: 'matkul/edit.php',
                    type: 'get',
            ...
            $("#contentData").on("submit", "#formEditMtkl", function(e) {
                e.preventDefault();
                $.ajax({
            ...
            // jadwal
            $("#contentData").on("submit", "#formJdwl", function(e) {
                e.preventDefault();
                $.ajax({
            ...
            $("#contentData").on("click", "#deleteJdwl", function() {
            ...
            $("#contentData").on("click", "#editJdwl", function() {
                var id = $(this).attr("value");
                $.ajax({
                    url: 'jadwal/edit.php',
                    type: 'get',
            ...
            $("#contentData").on("submit", "#formEditJdwl", function(e) {
                e.preventDefault();
                $.ajax({
